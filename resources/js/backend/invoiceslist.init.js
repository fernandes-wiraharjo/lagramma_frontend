...
var Invoices = [{
    ...
    date: new Date(2022, 5, d - 24, 10, 45),
    invoice_amount: 415.96,
    status: 'Paid',
    billing_address: {
    ...
    date: new Date(2022, 12, d - 8, 8, 34),
    invoice_amount: 875,
    status: 'Unpaid',
    billing_address: {
    ...
    date: new Date(2022, 4, d - 17, 20, 34),
    invoice_amount: 875,
    status: 'Paid',
    billing_address: {
    ...
    date: new Date(2022, 6, d - 14, 20, 48),
    invoice_amount: 875,
    status: 'Paid',
    billing_address: {
    ...
    date: new Date(2021, 2, d - 11, 10, 60),
    invoice_amount: 875,
    status: 'Refund',
    billing_address: {
    ...
    date: new Date(2022, 3, d - 8, 21, 58),
    invoice_amount: 875,
    status: 'Paid',
    billing_address: {
    ...
    date: new Date(2022, 3, d - 16, 21, 58),
    invoice_amount: 875,
    status: 'Cancel',
    billing_address: {
    ...
    date: new Date(2021, 3, d - 8, 21, 58),
    invoice_amount: 875,
    status: 'Paid',
    billing_address: {
    ...
    date: new Date(2021, 3, d - 22, 6, 12),
    invoice_amount: 875,
    status: 'Paid',
    billing_address: {
