...
<div class="card overflow-hidden rounded-4 shadow-blur p-4 order-summary-card">
    ...
    <div class="card-body pt-4 px-4">
            ...
            <table class="table table-borderless mb-0 fs-15">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end order-summary-value cart-shipping shipping-cost">-</td>
                    </tr>
                    <tr>
                        <td class="order-summary-total-label">Total</td>
                        <td class="text-end order-summary-total-value">
                            <span class="fw-semibold cart-total grand-total">Rp {{ number_format($subtotal, 0, ',', '.') }}</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="hstack gap-2 justify-content-between justify-content-end mt-4">
            ...
            <button class="create-order-btn btn-payment rounded-4" disabled>
                <span class="btn-text">Payment</span>
                <img src="{{ URL::asset('/build/images/icons/payment-01.svg') }}" />
                <span class="d-none spinner-border spinner-border-sm text-light spinner-checkout loading-spinner" role="status"></span>
            </button>
        </div>
    </div>
</div>
